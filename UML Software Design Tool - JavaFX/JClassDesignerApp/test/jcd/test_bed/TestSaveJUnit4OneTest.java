 ...
 * @author DennisSosa
 */
public class TestSaveJUnit4OneTest {
    
    public TestSaveJUnit4OneTest() {
    }
    ...
    /**
     * Test of hardTest1 method, of class TestSave.
     */
    @Test
    public void testHardTest1() {
        System.out.println("hardTest1");
        TestSave instance = new TestSave();
        instance.hardTest1();
        
        //DataManager dm = instance.getDM();
    ...
    public void testTestLoad() {
        ...
        assertEquals("Inheritance", dm.getDraggableLines().get(0).getLineType());
        assertEquals("Application", dm.getDraggableLines().get(0).getParentName());
        assertEquals("Drink", dm.getDraggableInterfaces().get(1).getInterfaceName());
    }
