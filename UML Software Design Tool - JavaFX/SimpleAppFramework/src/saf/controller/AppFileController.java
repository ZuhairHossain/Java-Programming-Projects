...
public class AppFileController {
    ...
    public void handlePhotoRequest(){
        ...
        fc.setInitialFileName("JClass");
        fc.setTitle("Choose Snapshot Name");
        ...
        WritableImage image = app.getWorkspaceComponent().getCanvas().snapshot(new SnapshotParameters(), null);
        ...
        if(selectedFile!=null){
            try{
                ...
                AppMessageDialogSingleton dialog = AppMessageDialogSingleton.getSingleton();
                PropertiesManager props = PropertiesManager.getPropertiesManager();
                dialog.show(props.getProperty("Snapshot Error"), props.getProperty("WARNING: There was an error when snapshotting \nthe render workspace."));
            }
        }
	...
	dc.setTitle("Export Code");
		...
		//app.getWorkspaceComponent().activateWorkspace(app.getGUI().getAppPane());
                ...
                e.printStackTrace();
                AppMessageDialogSingleton dialog = AppMessageDialogSingleton.getSingleton();
                dialog.show("Export Code Error", "ERROR: There was an error trying to export the code.");
            }
        }
    }
}
